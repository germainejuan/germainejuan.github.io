...
summary: Software Engineering students develop a web application that acts as a database of images of cats that were seen on University of Hawaiʻi at Mānoa campus grounds.
---

Share the cuteness of cats on campus with Meow Mapper!

Meow Mapper is a web application created by Germaine Juan, Maegan Chow, Nhan Bui, and Kha Bui as a class project for ICS 314 Software Engineering at University of Hawaiʻi at Mānoa.

The purpose of Meow Mapper is to serve as a database for cat photos specifically for cats that were spotted on UH Manoa campus. Only people affiliated with the University of Hawaiʻi system are able to log into the application and use it.

Once logged in, the user can access the full functionality of the application. The user can see the navigation bar, which includes Spay and Neuter, Snatch A Cat, Cat Snaps, Donations, and Volunteer.
...
The project was majority done by meeting with other members of the team on a common time to discuss and work on the project. Communication and teamwork was a big part of the process.

You can preview the website on this [page](https://meowmapper.com/#/).

To learn more about the project, you can visit our [project page](https://meow-mapper.github.io/).
